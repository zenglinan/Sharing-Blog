  ...
  <div id="detail">
    ...
    <section class="article">
      ...
      <blockquote>
        <p>
          ...
          出自于 <a
            ...
            target="_blank"
          >Chris House</a> 的个人博客，由<a
            href="https://jirengu.com"
            target="_blank"
          >饥人谷</a> <a
            href="https://www.zhihu.com/people/jirengu-ruo-yu"
            target="_blank"
          >若愚老师</a>翻译</p>
      </blockquote>
      <h2 id="引言">引言</h2>
      ...
      <p>有两个东西，启发我写这篇指南。 第一个是雷切尔·安德鲁（Rachel Andrew）的书<a
          ...
          target="_blank"
        >为CSS Grid布局准备</a>。 这本书对网格布局做了彻底、清晰的介绍，也是是整篇文章的基础，我强烈建议你购买并阅读他的书。 我的另一个重要灵感是Chris Coyier的<a
          href="https://css-tricks.com/snippets/css/a-guide-to-flexbox/"
          target="_blank"
        >Flexbox完全指南</a>，当需要查阅 flexbox 的一切资料时我就会找这篇文章。 这篇文章帮助了很多人学习 Flex 布局，也是 Google 上搜索“flexbox”关键字排名第一的文章。你会发现他的文章和我的很多相似之处，有最好的范例在那放着为什么咱不偷师学着写呢？</p>
      ...
      <blockquote>
        <p>浏览器支持的详细数据可在<a
            ...
            target="_blank"
          >Caniuse</a>查看。其中里面的数字表示该版本以上的浏览器支持Grid。</p>
      </blockquote>
...
<span class="hljs-tag">&lt;/<span class="hljs-name">div</span>&gt;</span>
  ...
  <span class="hljs-attribute">grid-template-rows</span>: <span class="hljs-number">25%</span> <span class="hljs-number">100px</span> auto;
      ...
      <p><img
          src="https://cloud.hunger-valley.com/18-1-11/55281623.jpg"
          alt=""
        ></p>
  ...
  <span class="hljs-attribute">grid-template-rows</span>: [row1-start] <span class="hljs-number">25%</span> [row1-end] <span class="hljs-number">100px</span> [third-line] auto [last-line];
      ...
      <p><img
          src="https://cloud.hunger-valley.com/18-1-11/1314820.jpg"
          alt=""
        ></p>
...
<span class="hljs-selector-class">.container</span> {
  ...
  <span class="hljs-attribute">grid-template-areas</span>: 
    ...
    <span class="hljs-string">"footer footer footer footer"</span>;
      ...
      <p><img
          src="https://cloud.hunger-valley.com/18-1-11/45883436.jpg"
          alt=""
        ></p>
  ...
  <span class="hljs-attribute">grid-row-gap</span>: <span class="hljs-number">15px</span>;
      ...
      <p><img
          src="https://cloud.hunger-valley.com/18-1-11/406531.jpg"
          alt=""
        ></p>
  ...
  <span class="hljs-attribute">justify-items</span>: start;
      ...
      <p><img
          src="https://cloud.hunger-valley.com/18-1-11/81852061.jpg"
          alt=""
        ></p>
      <pre><code class="lang-css"><span class="hljs-selector-class">.container</span>{
  <span class="hljs-attribute">justify-items</span>: end;
      ...
      <p><img
          src="https://cloud.hunger-valley.com/18-1-11/57749032.jpg"
          alt=""
        ></p>
      <pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  <span class="hljs-attribute">justify-items</span>: center;
      ...
      <p><img
          src="https://cloud.hunger-valley.com/18-1-11/73568687.jpg"
          alt=""
        ></p>
      <pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  <span class="hljs-attribute">justify-items</span>: stretch;
      ...
      <p><img
          src="https://cloud.hunger-valley.com/18-1-11/81147184.jpg"
          alt=""
        ></p>
  ...
  <span class="hljs-attribute">align-items</span>: start;
      ...
      <p><img
          src="https://cloud.hunger-valley.com/18-1-11/31201904.jpg"
          alt=""
        ></p>
      <pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  <span class="hljs-attribute">align-items</span>: end;
      ...
      <p><img
          src="https://cloud.hunger-valley.com/18-1-11/37389909.jpg"
          alt=""
        ></p>
      <pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  ...
  <span class="hljs-attribute">grid-template-rows</span>: <span class="hljs-number">90px</span> <span class="hljs-number">90px</span>
      ...
      <p><img
          src="https://cloud.hunger-valley.com/18-1-12/90644000.jpg"
          alt="Example of 2 x 2 grid"
        ></p>
      <p>这里创建了一个 2x2的网格。</p>
...
<span class="hljs-selector-class">.container</span> {
  ...
  <span class="hljs-attribute">grid-area</span>: <span class="hljs-number">1</span> / col4-start / last-line / <span class="hljs-number">6</span>
      ...
      <p><img
          src="https://cloud.hunger-valley.com/18-1-12/37070111.jpg"
